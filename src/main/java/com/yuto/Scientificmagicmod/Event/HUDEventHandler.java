...
import com.yuto.Scientificmagicmod.Player.SplitPowerStats;
...
public class HUDEventHandler {
	public static final ResourceLocation icons = new ResourceLocation("scientificmagicmod:textures/gui/icons.png");
    ...
    protected void renderSplitPower(int width, int height) {
        ...
        if (!visibleSplitPower || !SMConfig.statusSplitPower) return;
        visibleSplitPower = false;
    ...
    protected void renderMagicPower(int width, int height) {
        ...
        if (!visibleMagicPower || !SMConfig.statusMagicPower) return;
        visibleMagicPower = false;

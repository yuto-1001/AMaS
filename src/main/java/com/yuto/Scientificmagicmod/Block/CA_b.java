...
public class CA_b extends BlockBush {
	...
	protected CA_b() {
		...
		this.setBlockTextureName("scientificmagicmod:CA_bl");
	...
	public Item getItemDropped(int meta, Random random, int fortune) {
		return ScientificmagicItems.Bulb_b;
	}
	public CA_b idDropped1(int i, Random random, int j)
    {
        return this;
    }
	@Override

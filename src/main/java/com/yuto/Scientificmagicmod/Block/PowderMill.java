...
public class PowderMill extends BlockContainer {
	...
	public PowderMill(boolean b){
		...
		if(!b){
			...
			this.setBlockTextureName("scientificmagicmod:PowderMill");
			...
			this.setBlockTextureName("scientificmagicmod:PowderMill_on");
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		player.openGui(ScientificmagicMod.INSTANCE, ScientificmagicMod.PW, world, x, y, z);
        return true;
	}
	@Override
	...
	public static void updatePWBlockState(boolean b, World worldObj, int xCoord, int yCoord, int zCoord) {
        ...
        if (b){
            worldObj.setBlock(xCoord, yCoord, zCoord, ScientificmagicBlock.PowderMill_on);
        }
        else{
            worldObj.setBlock(xCoord, yCoord, zCoord, ScientificmagicBlock.PowderMill);
        }

...
public class ScientificmagicItems {
	...
	public static void registry( ScientificmagicMod mod )
	{
		...
		BlackSteel = new BlackSteel(EnumHelper.addToolMaterial("BlackSteel", 5, 999999999, 30F, 30, 64));
		WhiteSteel = new WhiteSteel(EnumHelper.addToolMaterial("WhiteSteel", 5, 999999999, 30F, 20, 64));

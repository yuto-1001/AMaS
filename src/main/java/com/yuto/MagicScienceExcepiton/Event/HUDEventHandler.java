...
import com.yuto.MagicScienceExcepiton.Player.SplitPowerStats;
...
public class HUDEventHandler {
    ...
    protected void renderSplitPower(int width, int height) {
        ...
        if (!visibleSplitPower || !MSEConfig.statusSplitPower) return;
        visibleSplitPower = false;
    ...
    protected void renderMagicPower(int width, int height) {
        ...
        if (!visibleMagicPower || !MSEConfig.statusMagicPower) return;
        visibleMagicPower = false;

...
import com.yuto.AMaS.Api.Event.PlayerSplitPowerEvent;
...
public class SplitPowerStats {
    ...
    public void addStats(EntityPlayer entityPlayer, int par1, float par2) {
        ...
        if (!AMaSConfig.statusSplitPower) return;
    ...
    public boolean isPacket() {
        ...
        if (!AMaSConfig.statusSplitPower) return false;
    ...
    public int getSplitPowerLevel() {
        ...
        if (!AMaSConfig.statusSplitPower) return MAX_SPLITPOWER_LEVEL;

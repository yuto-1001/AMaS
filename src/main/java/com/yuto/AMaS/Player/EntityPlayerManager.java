...
import com.yuto.AMaS.Api.IPlayerManager;
...
public class EntityPlayerManager implements IPlayerManager {
    ...
    public void onEntityJoinWorld(EntityJoinWorldEvent event) {
        ...
        if (!event.entity.worldObj.isRemote && event.entity instanceof EntityPlayer) {
            ...
            AMaSPacketHandler.INSTANCE.sendTo(new PacketPlayerData(this.getCustomPlayerData((EntityPlayer) event.entity)), (EntityPlayerMP) event.entity);
    ...
    public void onPlayerChangedDimension(PlayerEvent.PlayerChangedDimensionEvent event) {
        ...
        if (!event.player.worldObj.isRemote) {
            AMaSPacketHandler.INSTANCE.sendTo(new PacketPlayerData(this.getCustomPlayerData(event.player)), (EntityPlayerMP) event.player);
    ...
    public void sendOtherPlayer(EntityPlayer player) {
        ...
        AMaSPacketHandler.INSTANCE.sendToAllAround(d, new TargetPoint(player.dimension, player.posX, player.posY, player.posZ, 64));
    }

...
public class SwS extends ItemSword {
	private boolean isPutted = true;
	@SideOnly(Side.CLIENT)
	private IIcon[] iicon = new IIcon[2];
	public SwS(ToolMaterial material) {
		super(material);
		...
		this.setTextureName("amas:sws_i");
	...
	public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		System.out.println(this.isPutted);
	...
	private static void updateAttributes(NBTTagCompound nbtData)
	  {
	    int damage = nbtData.getBoolean("isPutted") ? 20 : 2;

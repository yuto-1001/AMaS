...
import com.yuto.AMaS.Gui.GuiScreenSpellCard;
...
public class SpellCard extends MagicItem {
	public float SpineCount;
	public int useCount;
	public SpellCard(int MPUR) {
		super(MPUR);
		String name = "SpellCard";

		this.setCreativeTab(AMaSAPI.AMaSTab);
		this.setTextureName("amas:spellCard");
	...
	public void onPlayerStoppedUsing(ItemStack itemStack, World world, EntityPlayer entityPlayer, int p_77615_4_)
    {
		if (!world.isRemote) {
		    ...
		    String spell = ((GuiScreenSpellCard) this.bookGui).getspellPageString();
	...
	public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer entityPlayer)
    {
		if(entityPlayer.isSneaking()) {
			if (world.isRemote)
				Minecraft.getMinecraft().displayGuiScreen(new GuiScreenSpellCard(entityPlayer, itemStack));
			return itemStack;
		}else {

...
public class CA_r extends BlockBush {
	...
	protected CA_r() {
		...
		this.setBlockTextureName("scientificmagicmod:CA_r");
	...
	public Item getItemDropped(int meta, Random random, int fortune) {
		return ScientificmagicItems.Bulb_r;
	}
	public CA_r idDropped1(int i, Random random, int j)
    {
        return this;
    }
	@Override
